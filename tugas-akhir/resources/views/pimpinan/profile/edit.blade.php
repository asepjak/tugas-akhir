                ...
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body text-center p-4">
                        ...
                        <input type="file" name="foto" id="fotoInput" class="form-control" accept="image/*"
                            style="display:none;" form="profileForm">
            ...
            <div class="col-lg-8 col-md-12">
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body p-4">
                        ...
                        <!-- Profile Form -->
                        <form id="profileForm" method="POST" action="{{ route('pimpinan.profile.update') }}"
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" id="floatingAlamat" name="alamat" placeholder="Alamat" style="height: 100px;">{{ old('alamat', $user->alamat) }}</textarea>
                                    ...
                                    <div class="form-floating mb-3">
                                        <select class="form-select" id="floatingStatus" name="status">
                                            ...
                                            <option value="Tidak Aktif"
                                                ...
                                                Aktif</option>
                                            <option value="Cuti"
                                                {{ old('status', $user->status) == 'Cuti' ? 'selected' : '' }}>Cuti
                                            </option>
                                        </select>
